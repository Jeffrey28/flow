...
Trains a single autonomous vehicle to stabilize the flow of 41 human-driven
...
flow_params = dict(
    ...
    initial=InitialConfig(bunching=20, spacing="uniform"),
)
